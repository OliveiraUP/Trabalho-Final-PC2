...
public class TelaCadastroHospedagem extends JFrame {
	...
	public TelaCadastroHospedagem() {
		...
		JTextField textFieldDesconto = new JTextField();
		...
		JTextField textFieldValorFinal = new JTextField();
		...
		JTextField textFieldCodiChale = new JTextField();
		textFieldCodiChale.setBounds(173, 63, 169, 20);
		contentPane.add(textFieldCodiChale);
		textFieldCodiChale.setColumns(10);
		...
		btnNewButtonSalvar.addActionListener(new java.awt.event.ActionListener() {
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
		    		...
		    		Integer codChale = Integer.parseInt(textFieldCodiChale.getText().toString());
